...
navItems: [
  { href: "/admin/dashboard", label: "总览", icon: "home" },
...
dashboard: { assignments: { items: [], total: 0, summary: {} }, loading: false, error: "", updatedAt: "" },
filters: {
...
candidateMaterialTab: "resume",
candidateMaterialPreview: { open: false, url: "", title: "" },
candidateEvaluation: "",
assignmentForm: {
  quiz_key: "",
  candidate_id: "",
...
assignmentQuizFilterOptions: { items: [], loading: false, loaded: false, query: "" },
assignmentQuizFilterTimer: null,
quizzes: { items: [] },
quizListSelectionKey: "",
